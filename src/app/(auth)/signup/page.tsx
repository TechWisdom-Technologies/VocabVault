...
export default function SignupPage() {
  ...
  const onGoogleSignup = async () => {
    ...
    try {
      ...
      const suffix = plan === 'pro' ? '?plan=pro' : '';
  ...
  return (
    <div className="h-screen bg-[#0a0a0b] flex overflow-hidden">
      ...
      >
        <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-[#fb731f]/5 blur-[100px] rounded-full pointer-events-none" />
        ...
        <div className="max-w-md">
          ...
          <h1 className="text-5xl font-bold text-white leading-tight mb-8">
            Internalize the language. <span className="text-[#fb731f]">Unlock</span> the vault.
          </h1>
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <p className="text-sm font-bold text-[#fb731f] uppercase tracking-widest">Ludwig Wittgenstein</p>
            </div>
          </div>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex flex-col relative">
        ...
        <div className="flex justify-end p-8 pb-0">
          <p className="text-sm text-white/40 font-medium">
            ...
            <Link href="/login" className="text-[#fb731f] font-bold hover:underline underline-offset-4">
              Sign in
            </Link>
          </p>
        </div>
            ...
            <div className="space-y-6">
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <Label htmlFor="password" className="text-xs font-bold text-white/60 ml-1">Password</Label>
                    <div className="relative">
                      <Input
                        id="password"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="confirmPassword" className="text-xs font-bold text-white/60 ml-1">Confirm</Label>
                    <Input
                      id="confirmPassword"
                      type={showPassword ? "text" : "password"}
                      placeholder="••••••••"
